...
$(function () {
  loadConfigFile()
  console.log('starting zendesk app forms');
...
//calling info from zendesk forms
function call_forms() {
...
//compara brands y dibuja los botones de formularios
function drawforms() {
...
//verify if brand is same on cache and selected
...
//send signal to request all forms to usame
function sync_forms() {
  var domain = domain_
